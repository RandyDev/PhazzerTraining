...
Public Class Login
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            If Request("Login") > "" Then
                ...
                If isValidEmail(login) Then
                    UserName.Text = Request("Login")
                End If
            End If
    ...
    Protected Sub LoginButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LoginButton.Click
        ...
        '    If usr.myRoles.Contains("Employee") Then
    ...
    Protected Function LoginError(ByVal usr As String) As String
        ...
        If usrInfo IsNot Nothing Then
            ...
            If usrInfo.IsLockedOut Then
                LoginError = "Your account has been locked out because of too many invalid login attempts.<br />Please call 703-869-3094 to have your account unlocked."
            ElseIf Not usrInfo.IsApproved Then
                If usrInfo.LastActivityDate < Date.Now.AddDays(-30) Then
                    LoginError = "This account has been disabled due to:<br />... no activity 30+ days ...<br />Please call 703-869-3094 and request to be reactivated."
                Else
    ...
    Private Sub BtnNoPass_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNoPass.Click
        FailureText.Text = "Please call 615-681-7423 between 9am and 5pm <br />and request a new password orcontact your manager"
        btnNoPass.Visible = False
        btnSendNewPassword.Visible = False
        Password.Visible = True
        PasswordLabel.Visible = True
    ...
    Private Sub BtnSendNewPassword_Click(sender As Object, e As EventArgs) Handles btnSendNewPassword.Click
        Response.Redirect("~/SignMeUp.aspx")
    End Sub
End Class
